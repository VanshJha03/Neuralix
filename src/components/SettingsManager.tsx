          ...
          <section className="p-6 lg:p-10 bg-zinc-900/60 border border-zinc-800 rounded-[2rem] lg:rounded-[3rem] relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="p-8 bg-zinc-950/50 border border-zinc-900 rounded-[2rem] space-y-6">
                <div>
                  <h4 className="text-[10px] font-black text-white uppercase tracking-widest mb-2 italic">Trajectory Support</h4>
                ...
                <div>
                  <h4 className="text-[10px] font-black text-white uppercase tracking-widest mb-2 italic">Creatio Protocol</h4>
                  <p className="text-zinc-500 text-[10px] font-medium leading-relaxed">
