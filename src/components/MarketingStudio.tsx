    ...
    return (
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="max-w-md w-full bg-zinc-950 border border-zinc-900 rounded-[2.5rem] p-10 text-center shadow-2xl animate-in fade-in zoom-in duration-500">
          ...
          <h2 className="text-2xl font-black text-white mb-4 tracking-tighter italic" style={{ fontFamily: "'Orbitron', sans-serif" }}>Marketing Studio</h2>
          ...
          <button 
            ...
            className="w-full py-4 bg-white text-black font-black uppercase tracking-widest text-xs rounded-xl hover:bg-zinc-200 transition-all shadow-xl"
          >
            Upgrade Neural Link
          </button>
        </div>
