...
import { Megaphone, MessageSquare, Twitter, Instagram, ArrowRight, Loader2, Copy, Check, Film, Trash2, Youtube, Image as ImageIcon, Edit3, X, Zap, Lock, Crown } from 'lucide-react';
...
const MarketingStudio: React.FC<MarketingStudioProps> = ({ ideas, interests, systemInstruction, onDeleteIdea, userSettings, isLocked = false, onSelectTier, onShowPricing }) => {
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-3xl p-6 overflow-y-auto">
            ...
            <div className="relative w-full max-w-lg bg-zinc-950/50 border border-white/5 rounded-[3rem] p-8 lg:p-14 shadow-[0_0_100px_rgba(0,0,0,0.8)] animate-in zoom-in-95 duration-700 text-center">
              ...
              <p className="text-zinc-500 text-sm font-normal max-w-xs mx-auto mb-8 leading-relaxed">
                Automated content synthesis and multi-platform asset production require a professional account.
              </p>
