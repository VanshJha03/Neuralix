        ...
        <div className="min-h-dvh bg-black flex flex-col items-center justify-center p-6 lg:p-12 overflow-y-auto">
            <div className="max-w-4xl w-full mx-auto flex flex-col items-center">
                <div className="mb-12 flex flex-col items-center text-center">
                    <NeuralLogo size={52} />
                    <h2 className="text-3xl lg:text-5xl font-black text-white mt-8 tracking-tighter italic" style={{ fontFamily: "'Orbitron', sans-serif" }}>
                        Activate Your Plan
                    </h2>
                    <p className="text-zinc-600 text-[11px] uppercase tracking-[0.4em] font-black mt-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
                    ...
                    <div className="relative p-8 rounded-[2.5rem] bg-zinc-950 border border-zinc-800 hover:border-zinc-600 transition-all flex flex-col">
                        ...
                        <h3 className="text-2xl font-black text-white tracking-tighter uppercase mb-1" style={{ fontFamily: "'Orbitron', sans-serif" }}>PRO</h3>
                        ...
                        <button
                            ...
                            disabled={!!loading}
                            className="w-full py-4 rounded-xl font-black uppercase tracking-[0.2em] text-[10px] border border-zinc-700 text-zinc-300 hover:border-white hover:text-white transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                    ...
                    <div className="relative p-8 rounded-[2.5rem] bg-white border border-white flex flex-col">
                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1.5 bg-black text-white text-[9px] font-black uppercase tracking-widest rounded-full shadow-xl">
                            Best Value
                        </div>
                        <div className="w-12 h-12 rounded-2xl bg-black/10 flex items-center justify-center mb-6 text-black">
                            <Crown size={22} />
                        </div>
                        <h3 className="text-2xl font-black text-black tracking-tighter uppercase mb-1" style={{ fontFamily: "'Orbitron', sans-serif" }}>LTD</h3>
                        <p className="text-zinc-500 text-[10px] uppercase tracking-widest mb-6">Lifetime · Pay once</p>
                        <div className="flex items-baseline gap-1 mb-8">
                            <span className="text-4xl font-black text-black">$129</span>
                            <span className="text-xs text-zinc-500 font-bold uppercase tracking-widest">once</span>
                        </div>
                        <ul className="space-y-3 mb-10 flex-1">
                            {FEATURES.map(f => (
                                <li key={f} className="flex items-start gap-3">
                                    <Check size={13} className="text-zinc-500 mt-0.5 shrink-0" />
                                    <span className="text-[11px] text-zinc-700 font-bold uppercase tracking-tight leading-tight">{f}</span>
                                </li>
                            ))}
                        </ul>
                        <button
                            ...
                            disabled={!!loading}
                            className="w-full py-4 rounded-xl font-black uppercase tracking-[0.2em] text-[10px] bg-black text-white hover:bg-zinc-900 transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
                        >
