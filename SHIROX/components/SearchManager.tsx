    ...
    <div className="relative h-full overflow-hidden">
      ...
      <div className="relative mb-12 lg:mb-24">
        ...
        <input
          ...
          placeholder="Query workspace history..."
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
        <section>
          <div className="flex items-center gap-4 mb-10">
            ...
            <h2 className="text-[10px] font-normal uppercase tracking-[0.5em] text-zinc-500">Workspace History</h2>
          </div>
          <div className="space-y-6">
            {filteredMessages.slice(0, 10).map(msg => (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  <span className="text-[9px] font-normal uppercase tracking-widest text-zinc-700 group-hover:text-zinc-500 transition-colors">{msg.role} entry</span>
            ...
            {query && filteredMessages.length === 0 && <p className="text-[10px] text-zinc-800 font-normal uppercase tracking-widest font-normal text-center py-12">No matches found.</p>}
          </div>
        </section>
